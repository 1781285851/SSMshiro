...
<head>
	...
	<script type="text/javascript" src="${pageScope.basePath}static/modules/sys/assets/js/core/jquery.3.2.1.min.js"></script>
	...
	<script type="text/javascript" src="${pageScope.basePath}static/modules/sys/assets/js/demo.js"></script>
										...
										<div class="row">
											...
											<div class="col-7 d-flex align-items-center">
												<div class="numbers">
													...
													<h4 class="card-title"><%=session.getAttribute("sum")%></h4>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="card card-stats card-danger">
									<div class="card-body ">
										<div class="row">
											...
											<div class="col-7 d-flex align-items-center">
												<div class="numbers">
													<p class="card-category">Breaking</p>
													<h4 class="card-title"><%=session.getAttribute("sumBreaking")%></h4>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="card card-stats card-danger">
									<div class="card-body ">
										<div class="row">
											...
											<div class="col-7 d-flex align-items-center">
												<div class="numbers">
													<p class="card-category">Poppin</p>
													<h4 class="card-title"><%=session.getAttribute("sumPoppin")%></h4>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="card card-stats card-danger">
									<div class="card-body ">
										<div class="row">
											...
											<div class="col-7 d-flex align-items-center">
												<div class="numbers">
													<p class="card-category">Locking</p>
													<h4 class="card-title"><%=session.getAttribute("sumLocking")%></h4>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="card card-stats card-danger">
									<div class="card-body ">
										<div class="row">
											...
											<div class="col-7 d-flex align-items-center">
												<div class="numbers">
													<p class="card-category">Hiphop</p>
													<h4 class="card-title"><%=session.getAttribute("sumHiphop")%></h4>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="card card-stats card-danger">
									<div class="card-body ">
										<div class="row">
											...
											<div class="col-7 d-flex align-items-center">
												<div class="numbers">
													<p class="card-category">Jazz</p>
													<h4 class="card-title"><%=session.getAttribute("sumJazz")%></h4>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="row">
											...
											<div class="col-7 d-flex align-items-center">
												<div class="numbers">
													...
													<h4 class="card-title"><%=session.getAttribute("sumShuffle")%></h4>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="card card-stats card-danger">
									<div class="card-body ">
										<div class="row">
											...
											<div class="col-7 d-flex align-items-center">
												<div class="numbers">
													<p class="card-category">Urban</p>
													<h4 class="card-title"><%=session.getAttribute("sumUrban")%></h4>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="card card-stats card-danger">
									<div class="card-body ">
										<div class="row">
											...
											<div class="col-7 d-flex align-items-center">
												<div class="numbers">
													<p class="card-category">Wacking</p>
													<h4 class="card-title"><%=session.getAttribute("sumWacking")%></h4>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="col-md-3">
								<div class="card">
									<div class="card-header">
										...
										<p class="card-category">总共</p>
									</div>
									<div class="card-body">
										<div id="task-complete" class="card-title mt-1 mb-1">1,294</div>
									</div>
									<div class="card-footer">
										<div class="legend"><i class="la la-circle text-primary"></i> OK</div>
									</div>
								</div>
							</div>
							<div class="col-md-9">
